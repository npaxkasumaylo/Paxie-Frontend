            ...
            {pagedLogs.length > 0 ? (
              pagedLogs.map((item) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-white/90">
                    <span>
                      {item.imageTextTokenInput + item.imageTextTokenOutput}
                    </span>
                  </td>
                </tr>
              ))
            ...
            <tfoot className="bg-[#27304d] border-t border-blue-400/10">
              <tr className="[&>th]:px-5 [&>th]:py-4 [&>th]:text-left [&>th]:text-lg [&>th]:font-semibold [&>th]:text-white/90">
                ...
                <th className="px-5 py-4 text-white">
                  {totals.textTokenCount}
                </th>
                <th className="px-5 py-4 text-white">
                  {totals.imageTextTokenInput}
                </th>
                <th className="px-5 py-4 text-white">
                  {totals.imageTextTokenOutput}
                </th>
                <th className="px-5 py-4 text-white">
                  {totals.imageTextTokenInput + totals.imageTextTokenOutput}
                </th>
              </tr>
            </tfoot>
          )}
